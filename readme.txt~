...
1)Down the zip file or clone the repository in a perticular folder..
...
2)You need to change the paths in the following files according to the location of the files in your pc
